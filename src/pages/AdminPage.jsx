            ...
            <div key={bike.id} className={`border rounded-lg p-4 hover:border-orange-300 transition-colors ${bike.sold ? "border-red-200 bg-red-50/50" : "border-gray-200"}`}>
              <div className="flex gap-3">
                ...
                <div className="w-20 h-20 flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden">
                  {bike.image_url ? (
                    <img src={bike.image_url.startsWith("http") ? bike.image_url : `${API_URL}${bike.image_url}`} alt={bike.title} className="w-full h-full object-cover" loading="lazy" decoding="async" />
                  ) : (
